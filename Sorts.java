...
public class Sorts {
   ...
   private static <T extends Comparable<? super T>> void BuildMaximum(T arr[], int n){
   ...
   public static <T extends Comparable<? super T>> void MaxHeap(T arr[], int n, int i)
